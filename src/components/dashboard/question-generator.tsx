...
export function QuestionGenerator() {
  ...
  useEffect(() => {
    ...
    if (aiModel === "o3-2025-04-16" && userCreditInfo?.tier !== "pro") {
      setAiModel("gpt-4.1");
    }
  }, [userCreditInfo?.tier]);
  ...
  const handleModelChange = (model: string) => {
    ...
    if (model === "o3-2025-04-16" && userCreditInfo?.tier !== "pro") {
            ...
            <div className="space-y-2">
              ...
              <Select value={aiModel} onValueChange={handleModelChange}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="o3-2025-04-16">IA Avançada {userCreditInfo?.tier !== "pro" && "(Pro)"}</SelectItem>
                </SelectContent>
              </Select>
